...
export default function Register() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-blue-900">
      <Image
        src="/cram.png"
      ...
      />
      <div className="relative bg-white/10 backdrop-blur-md p-8 rounded-lg shadow-lg w-full max-w-md border border-blue-500">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-blue-600 hover:bg-blue-500 text-white py-2 rounded-lg transition">
            Register
          </button>

          <p className="text-lg text-center text-gray-400 mt-4">
            I have an Account! <a href="/login" className="text-blue-400 hover:underline">Back to Login</a>
          </p>
        </form>
      </div>
    </div>
