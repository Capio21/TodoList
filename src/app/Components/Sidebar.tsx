...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`h-full ${isOpen ? "w-64" : "w-20"} flex h-screen bg-gray-800 p-4 flex-col justify-between border-r border-gray-700 shadow-xl transition-all duration-300`}>
