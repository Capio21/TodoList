...
export default function Sidebar() {
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      try {
        ...
        if (!token) return;
        const response = await axios.get(`https://32d7-2001-4451-8712-1800-91e2-26cf-1dd-5068.ngrok-free.app/api/notifications?authToken=${token}`);
  ...
  const markAsRead = async (id) => {
    try {
      await axios.put(`https://32d7-2001-4451-8712-1800-91e2-26cf-1dd-5068.ngrok-free.app/api/notifications/${id}/markAsRead`);
  ...
  const markAllAsRead = async () => {
    try {
      const token = sessionStorage.getItem("authToken");
      if (!token) return;
      await axios.put(`https://32d7-2001-4451-8712-1800-91e2-26cf-1dd-5068.ngrok-free.app/api/notifications/markAllAsRead?authToken=${token}`);
